...
\begin{note}
	...
	Now, $f(y) = f(x) + \displaystyle{\sum_{i=1}^{N} \frac{\partial f}{\partial x_i}(y_i - x_j) + \frac{1}{2}\sum_{i=1}^{N} \frac{\partial^2 f}{\partial x_i \partial x_j}(y_i - x_i)(y_j - x_j)}$\\
	$\Longrightarrow f(y)=f(x) + \displaystyle{\langle\begin{bmatrix} \frac{\partial f}{\partial x_1} \\. \\ . \\  \frac{\partial f}{\partial x_N}\end{bmatrix} \begin{bmatrix} {y_1 - x_1} \\. \\ . \\  {y_{N} - x_{N}}\end{bmatrix}\rangle} + \frac{1}{2}(y-x)^T \nabla^2 f(x) (y-x)$
\end{note}
